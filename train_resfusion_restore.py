...
from datamodule import LOLDataModule, RaindropDataModule
...
if __name__ == '__main__':
    ...
    # Training Info
    parser.add_argument('--dataset', default='LOL', type=str)
    parser.add_argument('--data_dir', default='../datasets/LOLdataset', type=str)
